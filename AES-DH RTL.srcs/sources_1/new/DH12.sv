module diffie_hellman_user1 #(
    parameter WIDTH = 127
) (
    input  logic         clk,
    input  logic         rst_n,
    output logic [WIDTH:0] public_key_a,    // This user's public key (outgoing)
    ...
    input  logic [WIDTH:0] public_key_b     // Other user's public key (incoming)
);
    ...
    localparam [WIDTH:0] PRIV_KEY = 128'h99112233445566778899AABBCCDDEEFF;
